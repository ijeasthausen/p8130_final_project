...
```{r}
#additional cleaning based on exploratory analysis
hospital_data_cleaned = hospital_data_cleaned %>%
  mutate(
    o2sat = as.factor(ifelse(o2sat > 95, "normal", "low")),
    
    temperature = as.factor(ifelse(temperature >= 36.1 & temperature <= 37.2, 'normal', ifelse(temperature < 36.1, 'low', 'high')))
  )
