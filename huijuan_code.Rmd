...
In the Forward Elimination procedure (without applying `olsrr` package), we got a model: __log_length_of_stay ~ is30dayreadmit + cindex + evisit + age + insurancetype + temperature_cat + heartrate_transformed + respirationrate_transformed + mean_arterial_pressure__.
