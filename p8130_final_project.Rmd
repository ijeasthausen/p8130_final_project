...
```
# Abstract
We present a linear regression model for the prediction of hospital length of stay. 
...
```
In table XXX, we present a prediction model for length of stay. The model explains 17.5% of the variability in length of stay. Bootstrapping was used to assess interal validity. 
