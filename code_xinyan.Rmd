...
plot(fitted(model_sw_0.01), resid(model_sw_0.01), xlab = "Predicted/Fitted value", ylab = "Residual")
title("(a) Residual Plot for log_length_of_stay ")
abline(0, 0)

# Quantile - Quantile plot (QQ-plot)

qqnorm(resid(model_sw_0.01), xlab = "Expected Value", ylab = "Residual", main = "")
qqline(resid(model_sw_0.01))
