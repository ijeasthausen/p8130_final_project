...
```{r bwd_full, message=FALSE, warning=FALSE, results = "hide"}
# fit
...
```{r bwd_back, message=FALSE, warning=FALSE, results = "hide"}
# step 1: no race
...
library(leaps)
leaps(x = data_bwd[,-1], y = data_bwd[,1], nbest=2, method="Cp")
```
